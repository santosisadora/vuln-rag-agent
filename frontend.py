    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            try:
                ...
                for line in response.iter_lines():
                    if line:
                        ...
                        if decoded_line.startswith("data: "):
                            ...
                            # Stream completed cleanly — stop iterating
                            elif data["type"] == "done":
                                break
                ...
                # The SSE stream closed — this is expected when the server finishes streaming.
                # full_response is already accumulated; fall through to save it.
                pass
            finally:
                # Always render the final response and save to history,
                # whether the stream ended cleanly or via ChunkedEncodingError.
                message_placeholder.markdown(full_response)
                if full_response:
